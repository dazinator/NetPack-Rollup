...
export class RollupDirOptions implements rollup.RollupDirOptions
{
    cache?: rollup.RollupCache;    input: string[] | { [entryName: string]: string; };
    output?: rollup.OutputOptionsDir;
